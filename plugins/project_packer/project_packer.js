...
/* harmony import */ var _ProjectLoader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ProjectLoader */ "./components/ProjectLoader.ts");
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.mjs");
...
class ProjectPanel {
            ...
            component: {
                ...
                data: () => {
                    ...
                    return ({
                        ...
                        collapsedFolders: (0,vue__WEBPACK_IMPORTED_MODULE_2__.reactive)({})
                    });
                },
                methods: {
                    selectPack: () => {
                    ...
                    toggleFolder(folderPath) {
                        var _a;
                        // @ts-ignore
                        this.collapsedFolders[folderPath] = !((_a = this.collapsedFolders[folderPath]) !== null && _a !== void 0 ? _a : false);
                        // @ts-ignore
                        this.packHtml = ProjectPanel.generatePackHtml(_ProjectLoader__WEBPACK_IMPORTED_MODULE_1__["default"].project);
                    }
                }
    ...
    static generatePackHtml(pack) {
        ...
        const generateHtml = (item, collapsedFolders) => {
            var _a;
            if (item.type === 'folder') {
                const isCollapsed = (_a = collapsedFolders[item.path]) !== null && _a !== void 0 ? _a : false;
...
/* harmony export */ });
/* harmony import */ var _vue_runtime_common_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vue.runtime.common.js */ "./node_modules/vue/dist/vue.runtime.common.dev.js");

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_vue_runtime_common_js__WEBPACK_IMPORTED_MODULE_0__);
...
} = _vue_runtime_common_js__WEBPACK_IMPORTED_MODULE_0__
